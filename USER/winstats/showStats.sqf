...
if (hasInterface) then {
    ...
    private _columns = ["", "Raiders", "Vipers"];
    private _picturePath = ["", _iconInf, _iconSoft, _iconFuel, _iconTotal];
    private _picturePathDescription = ["", "Infantry", "Cars", "Fuel", "Total"];
    ...
    if (!_draw) then {
        switch (_winner) do { 
            case west : { _resultText = "Raiders win";  }; 
            case east : {  _resultText = "Vipers win";  }; 
